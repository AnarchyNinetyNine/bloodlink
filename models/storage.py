...
from models.blood_compatibility import BloodCompatibility
from models.blood_request_confirmation import BloodRequestConfirmation
...
class Storage:
    ...
    def __init__(self):
        ...
        username = getenv('BLOODLINK_USER')
        password = getenv('BLOODLINK_PASSWORD')
        database = getenv('BLOODLINK_DATABASE')
